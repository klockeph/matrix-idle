...
var $author$project$Bars$kMAX_BAR = 100;
var $author$project$Bars$kMIN_BAR = 5;
...
var $author$project$Bars$randomBars = function (len) {
	return A2(
		$elm$random$Random$list,
		len,
		A2($elm$random$Random$int, $author$project$Bars$kMIN_BAR, $author$project$Bars$kMAX_BAR));
};
var $author$project$Main$generateRandomBars = function (cnt) {
	return A2(
		$elm$random$Random$generate,
...
var $author$project$Main$checkSortedAndCmd = function (model) {
	if ($author$project$Bars$barsSorted(model.bars)) {
		...
		return $elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[
					$author$project$Main$generateRandomBars(count),
					A2(
					$elm$core$Task$perform,
					function (_v0) {
						return $author$project$Main$AddCoins(count * 4);
					},
					$elm$core$Task$succeed(_Utils_Tuple0))
				]));
	} else {
		...
		if (_v0.$ === 'Nothing') {
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						active_bar: $elm$core$Maybe$Just(clicked)
					}),
				$elm$core$Platform$Cmd$none);
		} else {
			var active_bar = _v0.a;
			if (_Utils_eq(active_bar, clicked)) {
				return _Utils_Tuple2(
					_Utils_update(
						model,
				...
				var mi = A2($elm$core$Basics$min, active_bar, clicked);
				var ma = A2($elm$core$Basics$max, active_bar, clicked);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{active_bar: $elm$core$Maybe$Nothing}),
...
var $author$project$Main$ActivateAlgorithm = function (a) {
	return {$: 'ActivateAlgorithm', a: a};
};
var $author$project$Buttons$Active = {$: 'Active'};
var $author$project$Buttons$Inactive = {$: 'Inactive'};
...
var $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$fill_color = function (color) {
	return A4(
		$matheus23$elm_tailwind_modules_base$Tailwind$Color$propertyWithColor,
		'fill',
		function (c) {
...
var $matheus23$elm_default_tailwind_modules$Tailwind$Theme$lime_700 = A5($matheus23$elm_tailwind_modules_base$Tailwind$Color$Color, 'rgb', '77', '124', '15', $matheus23$elm_tailwind_modules_base$Tailwind$Color$ViaVariable);
var $author$project$Buttons$clickableButtonStyle = _List_fromArray(
	[
		$rtfeldman$elm_css$Css$hover(
		_List_fromArray(
			[
				$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$bg_color($matheus23$elm_default_tailwind_modules$Tailwind$Theme$lime_700),
				$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$fill_color($matheus23$elm_default_tailwind_modules$Tailwind$Theme$lime_700)
			]))
	]);
...
var $matheus23$elm_default_tailwind_modules$Tailwind$Theme$lime_400 = A5($matheus23$elm_tailwind_modules_base$Tailwind$Color$Color, 'rgb', '163', '230', '53', $matheus23$elm_tailwind_modules_base$Tailwind$Color$ViaVariable);
...
var $author$project$Buttons$baseButtonStyle = _List_fromArray(
	[
		$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$text_color($matheus23$elm_default_tailwind_modules$Tailwind$Theme$lime_400),
...
var $author$project$Buttons$coloredButtonStyle = function (color) {
	return _Utils_ap(
		$author$project$Buttons$baseButtonStyle,
		_List_fromArray(
			[
				$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$bg_color(color),
				$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$fill_color(color)
			]));
};
var $matheus23$elm_default_tailwind_modules$Tailwind$Theme$lime_900 = A5($matheus23$elm_tailwind_modules_base$Tailwind$Color$Color, 'rgb', '54', '83', '20', $matheus23$elm_tailwind_modules_base$Tailwind$Color$ViaVariable);
var $author$project$Buttons$activeButtonStyle = _Utils_ap(
	$author$project$Buttons$coloredButtonStyle($matheus23$elm_default_tailwind_modules$Tailwind$Theme$lime_900),
	$author$project$Buttons$clickableButtonStyle);
...
var $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$opacity_50 = A2($rtfeldman$elm_css$Css$property, 'opacity', '0.5');
var $author$project$Buttons$disabledButtonStyle = _Utils_ap(
	$author$project$Buttons$baseButtonStyle,
	_List_fromArray(
		[
			$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$bg_color($matheus23$elm_default_tailwind_modules$Tailwind$Theme$black),
			$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$opacity_50,
			$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$cursor_not_allowed
		]));
var $author$project$Buttons$inactiveButtonStyle = _Utils_ap(
	$author$project$Buttons$coloredButtonStyle($matheus23$elm_default_tailwind_modules$Tailwind$Theme$black),
	$author$project$Buttons$clickableButtonStyle);
var $author$project$Buttons$myButtonStyle = function (s) {
	switch (s.$) {
		case 'Inactive':
			return $author$project$Buttons$inactiveButtonStyle;
		case 'Active':
			return $author$project$Buttons$activeButtonStyle;
		default:
			return $author$project$Buttons$disabledButtonStyle;
	}
};
...
var $author$project$Buttons$myOnPress = F2(
	function (onPress, state) {
		if (state.$ === 'Disabled') {
			...
			return _List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$Events$onClick(onPress)
				]);
		}
	});
...
var $author$project$Buttons$myButton = function (spec) {
	return A2(
		$rtfeldman$elm_css$Html$Styled$button,
		_Utils_ap(
			A2($author$project$Buttons$myOnPress, spec.onPress, spec.state),
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$Attributes$css(
					$author$project$Buttons$myButtonStyle(spec.state))
				])),
		_List_fromArray(
			[
				A2(
...
var $author$project$Main$algoActivateButton = function (algo) {
	return $author$project$Buttons$myButton(
		{
			label: algo.name,
			onPress: $author$project$Main$ActivateAlgorithm(algo.algo),
			state: algo.active ? $author$project$Buttons$Active : $author$project$Buttons$Inactive
		});
};
var $author$project$Main$BuyAlgorithm = function (a) {
	return {$: 'BuyAlgorithm', a: a};
};
var $author$project$Buttons$Disabled = {$: 'Disabled'};
var $author$project$Buttons$mySimpleButton = function (spec) {
	return $author$project$Buttons$myButton(
		{
			label: spec.label,
			onPress: spec.onPress,
			state: spec.enabled ? $author$project$Buttons$Inactive : $author$project$Buttons$Disabled
		});
};
var $author$project$Main$algoBuyButton = F2(
	function (coins, algo) {
		return $author$project$Buttons$mySimpleButton(
			{
				enabled: _Utils_cmp(coins, algo.price) > 0,
				label: algo.name + ('\nCost: ' + $elm$core$String$fromInt(algo.price)),
				onPress: $author$project$Main$BuyAlgorithm(algo.algo)
			});
	});
var $author$project$Main$algoButton = F2(
	function (coins, algo) {
		return algo.unlocked ? $author$project$Main$algoActivateButton(algo) : A2($author$project$Main$algoBuyButton, coins, algo);
	});
var $rtfeldman$elm_css$Html$Styled$div = $rtfeldman$elm_css$Html$Styled$node('div');
var $elm$core$List$sortBy = _List_sortBy;
var $author$project$Main$algoButtons = F2(
	function (algos, coins) {
		return A2(
			$rtfeldman$elm_css$Html$Styled$div,
			_List_Nil,
			A2(
				$elm$core$List$map,
				$author$project$Main$algoButton(coins),
				A2(
...
var $author$project$Bars$getBarHeight = F2(
	function (max_height, bar) {
		return $elm$core$Basics$round((max_height / ($author$project$Bars$kMAX_BAR + 1)) * bar);
	});
var $author$project$Bars$getBarPos = F3(
	function (width, padding, idx) {
		return $elm$core$String$fromInt((idx * (width + padding)) + padding);
	});
...
var $author$project$Main$kWIDTH = 800;
var $rtfeldman$elm_css$Css$prop1 = F2(
	function (key, arg) {
		return A2($rtfeldman$elm_css$Css$property, key, arg.value);
	});
var $rtfeldman$elm_css$Css$left = $rtfeldman$elm_css$Css$prop1('left');
var $author$project$Main$ChangeBarCount = function (a) {
	return {$: 'ChangeBarCount', a: a};
};
var $author$project$Bars$kMAX_BARS = 17;
var $author$project$Bars$kMIN_BARS = 4;
var $author$project$Main$problemSizeButtons = function (bar_count) {
	return A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				{
					enabled: _Utils_cmp(bar_count, $author$project$Bars$kMIN_BARS) > 0,
					label: '<',
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$rtfeldman$elm_css$Svg$Styled$Attributes$width(
									$elm$core$String$fromInt($author$project$Main$kWIDTH)),
									$rtfeldman$elm_css$Svg$Styled$Attributes$height(
									$elm$core$String$fromInt($author$project$Main$kHEIGHT)),
									$rtfeldman$elm_css$Svg$Styled$Attributes$viewBox(
									'0 0 ' + ($elm$core$String$fromInt($author$project$Main$kWIDTH) + (' ' + $elm$core$String$fromInt($author$project$Main$kHEIGHT))))
								]),
							_Utils_ap(
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												...
												$rtfeldman$elm_css$Svg$Styled$Attributes$width('800'),
												$rtfeldman$elm_css$Svg$Styled$Attributes$height('600'),
												$rtfeldman$elm_css$Svg$Styled$Attributes$fill('lightgrey'),
